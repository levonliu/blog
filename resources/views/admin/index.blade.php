...
@section('content')
	...
	<div class="top_box">
		...
		<div class="top_right">
			<ul>
				<li>管理员：admin</li>
				<li><a href="{{url('admin/pwd')}}" target="main">修改密码</a></li>
		...
		<ul>
			<li>
				...
				<ul class="sub_menu">
					...
					<li><a href="{{url('admin/article/create')}}" target="main"><i class="fa fa-fw fa-book"></i>新增文章</a></li>
			...
			<li>
				...
				<ul class="sub_menu" style="display: block">
					...
					<li><a href="{{url('admin/conf')}}" target="main"><i class="fa fa-fw fa-gears"></i>网站配置</a></li>
				</ul>
			</li>
			{{--<li>--}}
	...
	<div class="bottom_box">
		CopyRight © 2015. Powered By <a href="http://www.blog.com">http://www.blog.com</a>.
	</div>
	<!--底部 结束-->
@endsection
